...
export function StrategyMarketPage() {
  ...
  const texts = {
    pt: {
      ...
      subtitle: 'DATABASE GLOBAL DE ESTRATÉGIAS',
      description:
        'Descubra, analise e clone algoritmos de trading de alta performance',
      search: 'BUSCAR PARÂMETROS...',
      all: 'TODOS OS PROTOCOLOS',
      popular: 'TRENDING',
      recent: 'MAIS RECENTES',
      myStrategies: 'MINHA BIBLIOTECA',
      noStrategies: 'SEM SINAL',
      noStrategiesDesc: 'Nenhum sinal estratégico detectado nesta frequência',
      author: 'OPERADOR',
      createdAt: 'TIMESTAMP',
      ...
      copied: 'COPIADO',
      configHidden: 'ENCRIPTADO',
      configHiddenDesc: 'Parâmetros de configuração criptografados',
