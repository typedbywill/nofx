  ...
  return (
    <DeepVoidBackground className="min-h-screen pb-12" disableAnimation>
      <div className="w-full px-4 md:px-8 relative z-10 pt-6">
        ...
        <div className="mb-6 rounded-xl p-6 bg-[#0B0E11] border border-white/5 flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 mb-6">
          ...
          <div className="xl:col-span-8 flex flex-col gap-6">
            ...
            {/* Current Positions */}
            <div className="bg-[#0B0E11] p-6 rounded-xl border border-white/5">
              ...
              >
                {decisions && decisions.length > 0 ? (
                  ...
                  <div className="py-16 text-center text-nofx-text-muted opacity-60">
                    <div className="text-6xl mb-4 opacity-30 grayscale pulse-glow">
                      🧠
                    </div>
        ...
        {selectedTraderId && (
          <div className="bg-[#0B0E11] p-6 rounded-xl border border-white/5 relative overflow-hidden">
