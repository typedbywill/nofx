...
export const translations = {
  "pt": {
    ...
    "footerWarning": "⚠️ Operar envolve riscos. Use por sua própria conta e risco.",
    ...
    "dataWillAppear": "A curva de patrimônio aparecerá após executar alguns ciclos",
    ...
    "backtestPage": {
      ...
      "subtitle": "Escolha um modelo + intervalo de tempo para simular o loop completo de decisão da IA.",
      ...
      "form": {
        ...
        "enabled": "Ativado",
        "disabled": "Desativado",
        "noModelWarning": "Por favor, adicione e ative um modelo de IA na página de Configuração de Modelos primeiro.",
        ...
        "customPromptPlaceholder": "Anexe ou personalize totalmente o prompt da estratégia"
      },
      "runList": {
        "title": "Execuções",
      ...
      "toasts": {
        ...
        "confirmDelete": "Excluir backtest {id}? Esta ação não pode ser desfeita.",
      ...
      "decisionTrail": {
        ...
        "emptyHint": "O log de pensamento e execução da IA aparecerá quando a execução começar."
      },
      "charts": {
    ...
    "dashboardEmptyDescription": "Crie seu primeiro trader de IA para automatizar sua estratégia. Conecte uma corretora, escolha um modelo de IA e comece a operar em minutos!",
    ...
    "configureModelsAndExchangesFirst": "Por favor, configure os modelos de IA e corretoras primeiro",
    ...
    "enabled": "Ativado",
    "save": "Salvar",
    "fetchBalanceEditModeOnly": "Só é possível buscar o saldo atual no modo de edição",
    ...
    "selectStrategyAndConfigParams": "Selecione a Estratégia e Configure os Parâmetros Básicos",
    ...
    "show": "Mostrar",
    "hide": "Ocultar",
    "hiddenInCompetition": "Este trader não será exibido na página de competição quando oculto",
    "initialBalanceLabel": "Saldo Inicial ($)",
    "fetching": "Buscando...",
    "fetchCurrentBalance": "Buscar Saldo Atual",
    "balanceUpdateHint": "Usado para atualizar manualmente a base do saldo inicial (ex: após depósito/saque)",
    "autoFetchBalanceInfo": "O sistema buscará automaticamente o patrimônio da sua conta como saldo inicial",
    ...
    "hyperliquidPrivateKeyDesc": "Hyperliquid usa chave privada para autenticação de trading",
    "hyperliquidWalletAddressDesc": "Endereço da carteira correspondente à chave privada",
    "hyperliquidAgentWalletTitle": "Configuração da Agent Wallet Hyperliquid",
    "hyperliquidAgentWalletDesc": "Use Agent Wallet para mais segurança: Ela assina as transações (saldo ~0), a carteira principal guarda os fundos (nunca exponha a chave privada dela)",
    "hyperliquidAgentPrivateKey": "Chave Privada do Agente",
    "enterHyperliquidAgentPrivateKey": "Digite a chave privada da Agent Wallet",
    "hyperliquidAgentPrivateKeyDesc": "Chave privada da Agent Wallet para assinar transações (mantenha saldo próximo a 0 por segurança)",
    "hyperliquidMainWalletAddress": "Endereço da Carteira Principal",
    "enterHyperliquidMainWalletAddress": "Digite o endereço da Carteira Principal",
    "hyperliquidMainWalletAddressDesc": "Endereço da carteira que guarda seus fundos (nunca exponha a chave privada)",
    "asterApiProTitle": "Configuração da Carteira Aster API Pro",
    "asterApiProDesc": "Use a carteira API Pro para mais segurança: Ela assina as transações, a principal guarda os fundos (nunca exponha a chave privada da principal)",
    "asterUserDesc": "Endereço principal - A carteira EVM que você usa para acessar a Aster (Nota: Apenas carteiras EVM suportadas)",
    "asterSignerDesc": "Endereço da carteira API Pro (0x...) - Gere em https://www.asterdex.com/en/api-wallet",
    "asterPrivateKeyDesc": "Chave privada da carteira API Pro - Obtenha em https://www.asterdex.com/en/api-wallet (usada apenas localmente, nunca transmitida)",
    "asterUsdtWarning": "Importante: Aster rastreia apenas saldo USDT. Use USDT como moeda de margem para evitar erros no cálculo de PnL por flutuações de preço (BNB, ETH, etc.)",
    ...
    "enterLighterApiKeyPrivateKey": "Digite chave privada da API Key (40 bytes, opcional)",
    "lighterWalletAddressDesc": "Seu endereço Ethereum para identificação da conta",
    "lighterPrivateKeyDesc": "Chave privada L1 para identificação (ECDSA 32-bytes)",
    "lighterApiKeyPrivateKeyDesc": "Chave privada da API para assinar transações (Poseidon2 40-bytes)",
    "lighterApiKeyOptionalNote": "Sem a API Key, o sistema usará o modo V1 limitado",
    "lighterV1Description": "Modo Básico - Funcionalidade limitada, apenas testes",
    "lighterV2Description": "Modo Completo - Suporta assinaturas Poseidon2 e trading real",
    ...
    "secureInputHint": "Capturado via entrada segura em 2 passos. Use 'Inserir Novamente' para atualizar o valor.",
    "twoStageModalTitle": "Entrada Segura de Chave",
    "twoStageModalDescription": "Use o fluxo de dois passos para inserir sua chave privada de {length} caracteres com segurança.",
    "twoStageStage1Title": "Passo 1 · Insira a primeira metade",
    "twoStageStage1Placeholder": "Primeiros 32 caracteres (incluindo 0x se houver)",
    "twoStageStage1Hint": "Continuar copiará uma string de ofuscação para a área de transferência.",
    "twoStageStage1Error": "Por favor, insira a primeira parte antes de continuar.",
    ...
    "twoStageStage2Hint": "Cole a ofuscação em algum lugar neutro e termine de inserir a chave.",
    "twoStageClipboardSuccess": "String copiada. Cole-a em qualquer campo de texto uma vez antes de finalizar.",
    "twoStageClipboardReminder": "Lembre-se de colar a string antes de enviar para evitar vazamentos no clipboard.",
    "twoStageClipboardManual": "Cópia falhou. Copie a string abaixo manualmente.",
    "twoStageBack": "Voltar",
    "twoStageSubmit": "Confirmar",
    "twoStageInvalidFormat": "Formato inválido. Esperado {length} caracteres hexadecimais.",
    "testnetDescription": "Conectar ao ambiente de testes para simulação de trading",
    ...
    "crossMarginDescription": "Margem cruzada: Todas as posições compartilham o saldo da conta como garantia",
    "isolatedMarginDescription": "Margem isolada: Cada posição gerencia sua garantia de forma independente",
    ...
    "tradingSymbolsPlaceholder": "Insira os pares, separados por vírgula (ex: BTCUSDT,ETHUSDT,SOLUSDT)",
    ...
    "tradingSymbolsDescription": "Vazio = pares padrão. Deve terminar em USDT (ex: BTCUSDT)",
    "btcEthLeverageValidation": "A alavancagem para BTC/ETH deve ser entre 1-50x",
    "altcoinLeverageValidation": "A alavancagem para Altcoins deve ser entre 1-20x",
    "invalidSymbolFormat": "Formato de par inválido: {symbol}, deve terminar em USDT",
    ...
    "promptDescDefaultContent": "Maximiza Índice Sharpe, risco/retorno balanceado, ideal para iniciantes",
    "promptDescAdaptive": "🛡️ Estratégia Conservadora (v6.0.0)",
    "promptDescAdaptiveContent": "Controle rígido de risco, confirmação obrigatória do BTC, alta taxa de acerto",
    "promptDescAdaptiveRelaxed": "⚡ Estratégia Agressiva (v6.0.0)",
    "promptDescAdaptiveRelaxedContent": "Trading de alta frequência, confirmação opcional do BTC, foca em oportunidades",
    "promptDescHansen": "🎯 Estratégia Hansen",
    "promptDescHansenContent": "Estratégia customizada, maximiza Índice Sharpe, para traders profissionais",
    "promptDescNof1": "🌐 Framework NoF1 (Inglês)",
    "promptDescNof1Content": "Especialista em Hyperliquid, maximiza retornos ajustados ao risco",
    "promptDescTaroLong": "📈 Estratégia de Posição Long Taro",
    "promptDescTaroLongContent": "Decisões baseadas em dados, evolução contínua, especialista em operações Long",
    "loading": "Carregando...",
    "inUse": "Em Uso",
    ...
    "oiTopDescription": "Endpoint do ranking de Open Interest (OI), deixe em branco para desativar",
    "information": "Informação",
    "signalSourceInfo1": "• A configuração é por usuário, cada um pode definir suas próprias URLs",
    "signalSourceInfo2": "• Ao criar traders, você pode escolher usar ou não estas fontes de sinal",
    "signalSourceInfo3": "• As URLs configuradas serão usadas para buscar dados e sinais de trading",
    "editAIModel": "Editar Modelo de IA",
    "addAIModel": "Adicionar Modelo de IA",
    "confirmDeleteModel": "Tem certeza que deseja excluir esta configuração de IA?",
    "cannotDeleteModelInUse": "Não é possível excluir, pois está em uso por traders",
    "tradersUsing": "Traders usando esta configuração",
    "pleaseDeleteTradersFirst": "Por favor, exclua ou reconfigure os traders primeiro",
    ...
    "modelConfigInfo2": "• URL Base e Nome do Modelo só são necessários para proxies",
    "modelConfigInfo3": "• A chave da API é criptografada e armazenada de forma segura",
    ...
    "exchangeConfigWarning1": "• As chaves serão criptografadas. Recomendamos usar permissão de leitura ou apenas Futuros",
    "exchangeConfigWarning2": "• Nunca conceda permissão de saque",
    "exchangeConfigWarning3": "• Ao excluir, os traders não conseguirão mais operar",
    "edit": "Editar",
    "viewGuide": "Ver Guia",
    "binanceSetupGuide": "Guia de Configuração da Binance",
    "closeGuide": "Fechar",
    "whitelistIP": "Lista de IP Permitidos",
    "whitelistIPDesc": "A Binance exige adicionar o IP do servidor na whitelist da API",
    ...
    "exchangeConfigNotExist": "Configuração da corretora inexistente ou desativada",
    ...
    "passwordNotMeetRequirements": "A senha não atende aos requisitos de segurança",
    ...
    "passwordStrengthHint": "Use pelo menos 8 caracteres misturando letras, números e símbolos",
    ...
    "registrationClosedMessage": "Os registros estão desativados no momento. Contate um administrador.",
    "githubStarsInDays": "2.5K+ Estrelas no GitHub em 3 dias",
    "heroTitle1": "Leia o Mercado.",
    "heroTitle2": "Escreva o Trade.",
    "heroDescription": "A NOFX é o futuro do trading com IA — um OS open-source guiado pela comunidade. Suporta Binance, Aster DEX, hospedagem própria, competição entre bots, permitindo que a IA decida e otimize seus trades.",
    "poweredBy": "Desenvolvido por Aster DEX e Binance.",
    "readyToDefine": "Pronto para definir o futuro do trading com IA?",
    "startWithCrypto": "Começando no mercado de cripto, expandindo para Finanças Tradicionais.",
    ...
    "openSourceDesc": "Seu framework, suas regras. Sem caixas pretas, suporte a prompts customizados e multi-modelos.",
    ...
    "multiAgentDesc": "Estratégias de IA batalham em alta velocidade no sandbox. A sobrevivência do mais apto dita a evolução.",
    ...
    "secureDesc": "Segurança de nível corporativo, controle total de seus fundos e estratégias.",
    ...
    "nofxNotAnotherBot": "A NOFX não é só mais um bot, mas sim o 'Linux' do trading com IA —",
    "nofxDescription1": "um sistema operacional transparente, aberto e unificado,",
    "nofxDescription2": "oferecendo a camada 'decisão-risco-execução' para qualquer ativo.",
    "nofxDescription3": "Começando em cripto (24/7), futuramente em ações e forex. Core focado em IA aberta,",
    "nofxDescription4": "Darwinismo (competição entre agentes), evoluindo o CodeFi",
    ...
    "step1Desc": "git clone https://github.com/NoFxAiOS/nofx e mude para a branch dev.",
    "step2Title": "Configure o Ambiente",
    "step2Desc": "Configure as credenciais de API das corretoras e modelos de IA no frontend.",
    "step3Title": "Deploy & Execução",
    "step3Desc": "Deploy rápido via Docker. Aviso: Mercado de alto risco, teste apenas com dinheiro que pode perder.",
    "step4Title": "Otimize e Contribua",
    "step4Desc": "Monitore os resultados e envie PRs para melhorar. Junte-se ao Telegram.",
    "importantRiskWarning": "Aviso de Risco Importante",
    "riskWarningText": "A branch dev é instável, não use fundos que não pode perder. A NOFX não tem custódia dos fundos. Negociações envolvem riscos.",
    ...
    "loginRegisterPrompt": "Por favor, faça login ou cadastre-se para acessar a plataforma",
    ...
    "ai500ApiNotConfigured": "API do provedor de dados AI500 não configurada ou inacessível",
    "apiConnectionTimeout": "Timeout na conexão ou dados vazios retornados",
    "noCustomCoinsAndApiFailed": "Nenhuma moeda customizada configurada e falha na busca da API",
    "solutions": "Soluções:",
    "setCustomCoinsInConfig": "Defina uma lista customizada nas configurações do trader",
    "orConfigureCorrectApiUrl": "Ou configure a URL correta da API de dados",
    "orDisableAI500Options": "Ou desative o provedor de dados AI500 nas configurações",
    "signalSourceNotConfigured": "Fonte de Sinal Não Configurada",
    "signalSourceWarningMessage": "Você ativou opções de dados AI500, mas a API de fonte de sinal não está configurada.",
    ...
    "faqWhatIsNOFXAnswer": "NOFX é um sistema operacional open-source para trading automatizado com IA (DeepSeek, GPT, Claude, etc). Oferece gerenciamento multi-contas, multi-agentes e backtest.",
    "faqHowDoesItWork": "Como a NOFX funciona?",
    "faqHowDoesItWorkAnswer": "1) Você configura as APIs da exchange e IA; 2) Cria uma estratégia; 3) Configura um 'Trader'; 4) Ele avalia o mercado e executa ordens; 5) O raciocínio é explicado via log detalhado.",
    "faqIsProfitable": "A NOFX é lucrativa?",
    "faqIsProfitableAnswer": "A IA é experimental e NÃO é lucro garantido. O mercado de futuros de criptomoedas é volátil. Recomenda-se começar pequeno, em contas testnet e entender os riscos.",
    "faqSupportedExchanges": "Quais corretoras são suportadas?",
    "faqSupportedExchangesAnswer": "CEX: Binance, Bybit, OKX, Bitget. DEX: Hyperliquid, Aster DEX, Lighter. Leia a documentação para saber como configurá-las corretamente.",
    "faqSupportedAIModels": "Quais modelos de IA são suportados?",
    "faqSupportedAIModelsAnswer": "DeepSeek (recomendado), Qwen, GPT, Claude, Gemini, Kimi. Você também pode usar APIs compatíveis com o padrão OpenAI.",
    "faqSystemRequirements": "Quais são os requisitos do sistema?",
    "faqSystemRequirementsAnswer": "Mínimo 2 Cores CPU, 2GB RAM. Docker é fortemente recomendado. Suporta Linux, macOS ou Windows via WSL2.",
    "faqHowToInstall": "Como eu instalo a NOFX?",
    "faqHowToInstallAnswer": "O jeito mais fácil é via Docker. Use o script install.sh do repositório, ou faça o build manual com Go e Node.js.",
    "faqWindowsInstallation": "Como instalar no Windows?",
    "faqWindowsInstallationAnswer": "Use o Docker Desktop ou WSL2 rodando o script oficial Linux dentro do subsistema.",
    "faqDockerDeployment": "O deploy do Docker continua falhando",
    "faqDockerDeploymentAnswer": "Verifique a RAM, se o Docker está rodando, ou limpe o cache (`docker compose build --no-cache`).",
    "faqManualInstallation": "Como instalar manualmente para dev?",
    "faqManualInstallationAnswer": "Pré-requisitos: Go 1.21+, Node.js 18+, TA-Lib. Clone o repositório, compile o backend e inicie o servidor web com 'npm run dev'.",
    "faqServerDeployment": "Como faço deploy num servidor remoto?",
    "faqServerDeploymentAnswer": "Use o script via SSH. Exponha as portas corretas e considere usar Cloudflare ou proxy HTTPS.",
    "faqUpdateNOFX": "Como atualizar a NOFX?",
    "faqUpdateNOFXAnswer": "Execute 'docker compose pull' para baixar as imagens mais recentes e recrie os containers. Suas configurações e dados persistirão no sqlite.",
    "faqConfigureAIModels": "Como configuro modelos de IA?",
    "faqConfigureAIModelsAnswer": "Vá em Configuração > Modelos de IA. Adicione a chave secreta. O backend cuidará de encriptar a API antes de salvar.",
    "faqConfigureExchanges": "Como configuro minhas corretoras?",
    "faqConfigureExchangesAnswer": "Vá em Configuração > Corretoras. Para CEX, crie uma chave da API (APENAS com permissão de Trading Futuros). Para DEX, você precisará da Chave Privada da carteira autorizada.",
    "faqBinanceAPISetup": "Como configurar a Binance API?",
    "faqBinanceAPISetupAnswer": "1) Somente ativar Futuros; 2) Colocar seu IP na Whitelist (se possível); 3) Alterar a Binance para 'Hedge Mode' (Modo de Posição Dupla). Não funciona em One-way mode.",
    "faqHyperliquidSetup": "Como configuro a Hyperliquid?",
    "faqHyperliquidSetupAnswer": "Na Hyperliquid, gere uma Agent Wallet ou use a Private Key principal. É 100% on-chain sem KYC.",
    "faqCreateStrategy": "Como crio uma estratégia de trading?",
    "faqCreateStrategyAnswer": "No Estúdio, selecione Fontes de Dados, Indicadores Técnicos, Limites de Risco e adicione prompts customizados de IA.",
    "faqCreateTrader": "Como criar e iniciar um trader?",
    "faqCreateTraderAnswer": "Na aba Traders, clique criar, selecione IA + Corretora + Estratégia, defina a cadência de checagem (ex: 5min) e Inicie.",
    "faqHowAIDecides": "Como a IA decide?",
    "faqHowAIDecidesAnswer": "Via 'Chain of Thought' (Cadeia de Pensamento): ela analisa posições atuais, margem livre, oportunidade do momento no gráfico e escolhe comprar/vender/manter.",
    "faqDecisionFrequency": "Qual a frequência de decisão?",
    "faqDecisionFrequencyAnswer": "Você define (3-5 min recomendado). Rápido demais consome taxa da API e overtrading; lento demais perde entradas.",
    "faqNoTradesExecuting": "Por que meu trader não executa nada?",
    "faqNoTradesExecutingAnswer": "Falta de margem na conta de futuros, exchange em modo errado ou o bot decidiu ficar líquido (Hold). Veja os logs.",
    "faqOnlyShortPositions": "Por que a IA só entra em posições SHORT?",
    "faqOnlyShortPositionsAnswer": "Geralmente ocorre por estar no One-way mode na Binance. Mude para 'Hedge Mode' (Modo de Posição Dupla).",
    "faqLeverageSettings": "Como funciona a alavancagem?",
    "faqLeverageSettingsAnswer": "A IA gerencia com base no limite estipulado em risco (ex: máx 10x BTC). O bot envia as ordens já configuradas para o nível permitido.",
    "faqStopLossTakeProfit": "Suporta Stop-Loss (SL) / Take-Profit (TP)?",
    "faqStopLossTakeProfitAnswer": "A IA cuida da saída do trade com inteligência nativa, porém você pode adicionar instruções para alvos rigorosos via estratégia.",
    "faqMultipleTraders": "Posso rodar múltiplos traders?",
    "faqMultipleTradersAnswer": "Sim! Suporta 20+ em paralelo. Ótimo para testar variações de prompts.",
    "faqAICosts": "Qual o custo da IA?",
    "faqAICostsAnswer": "Varia. DeepSeek é o mais barato ($0.10 a $0.50/dia). OpenAI pode chegar a $5/dia em trades ativos a cada 5 minutos.",
    "faqPortInUse": "Porta 8080 ou 3000 em uso",
    "faqPortInUseAnswer": "Mate o processo antigo ou mude a variável no arquivo .env para NOFX_BACKEND_PORT=8081.",
    "faqFrontendNotLoading": "Frontend em loop 'Loading...'",
    "faqFrontendNotLoadingAnswer": "O Backend está fora. Rode 'docker compose logs nofx-backend' para ver os erros de compilação ou rede.",
    "faqDatabaseLocked": "Erro de Database Locked",
    "faqDatabaseLockedAnswer": "Dois backends rodando ao mesmo tempo. Derrube todos os processos ou apague arquivos -wal e -shm de data.db.",
    "faqTALibNotFound": "TA-Lib não encontrada",
    "faqTALibNotFoundAnswer": "Baixe a TA-Lib pelo seu gerenciador de pacotes nativo do OS. (brew install ta-lib no macOS, etc).",
    "faqAIAPITimeout": "Timeout da API de IA",
    "faqAIAPITimeoutAnswer": "Verifique a chave, limites de requisições por minuto do provedor ou falhas no IP da nuvem.",
    "faqBinancePositionMode": "Binance error -4061 (Position Mode)",
    "faqBinancePositionModeAnswer": "Você está usando One-way mode. Mude para o Hedge Mode (Posição Dupla) nas configurações de futuros da conta Binance.",
    "faqBalanceShowsZero": "O saldo da conta mostra zero",
    "faqBalanceShowsZeroAnswer": "O saldo em USDT deve estar na conta FUTUROS (USD-M), e não na conta Spot (À Vista).",
    "faqDockerPullFailed": "Docker falhou no pull de imagens",
    "faqDockerPullFailedAnswer": "Configure proxies ou tente baixar do repositório ghcr.io caso Docker Hub esteja lento.",
    "faqAPIKeyStorage": "Como as chaves da API são salvas?",
    "faqAPIKeyStorageAnswer": "Encriptadas via AES-256-GCM. A senha mestra fica no seu .env. O banco em sqlite só armazena o hash criptografado.",
    "faqEncryptionDetails": "Qual o nível de encriptação?",
    "faqEncryptionDetailsAnswer": "AES-256 para o banco, RSA para transporte (se ligado) e JWT. Altamente seguro contra roubos diretos de DB.",
    "faqSecurityBestPractices": "Boas práticas de segurança?",
    "faqSecurityBestPracticesAnswer": "Apenas permissões de trading (Sem Saques!), Whitelist de IP, use subcontas limitadas e ative transporte TLS.",
    "faqCanNOFXStealFunds": "A NOFX pode roubar meus fundos?",
    "faqCanNOFXStealFundsAnswer": "A NOFX é open source, hospedada na sua máquina e sem backdoors (você controla 100%). Configure sem permissão de saque para garantia absoluta.",
    "faqStrategyStudio": "O que é o Estúdio de Estratégias?",
    "faqStrategyStudioAnswer": "Um ambiente sem código onde você define as regras de engajamento, filtragem de tokens e níveis de agressividade.",
    "faqBacktestLab": "O que é o Laboratório de Backtest?",
    "faqBacktestLabAnswer": "Um ambiente de simulação com dados passados. Ele aciona o motor completo da IA como se fosse ao vivo.",
    "faqCompetitionMode": "O que é o Modo Competição?",
    "faqCompetitionModeAnswer": "Um ranking visual na interface dos seus bots brigando entre si (A/B testing) por PnL e Índice Sharpe.",
    "faqChainOfThought": "O que é Cadeia de Pensamento (CoT)?",
    "faqChainOfThoughtAnswer": "A trilha textual gravada onde a IA te explica a motivação que resultou no trade executado no ciclo.",
    "faqWhichAIModelBest": "Qual modelo de IA é melhor?",
    "faqWhichAIModelBestAnswer": "DeepSeek R1 para melhor custo/benefício. GPT-4o ou Claude 3.5 Sonnet para lógicas mais avançadas.",
    "faqCustomAIAPI": "Posso usar uma API de IA customizada?",
    "faqCustomAIAPIAnswer": "Sim. Basta inserir a Base URL proxy de provedores compatíveis com a biblioteca OpenAI no painel.",
    "faqAIHallucinations": "O que são alucinações da IA?",
    "faqAIHallucinationsAnswer": "Inventar dados. A NOFX ameniza isso passando a tabela real de preços a cada prompt para focar a mente da IA.",
    "faqCompareAIModels": "Como comparar modelos de IA?",
    "faqCompareAIModelsAnswer": "Crie o mesmo trader apenas mudando o modelo, e acompanhe o PnL no Dashboard de Competição.",
    "faqHowToContribute": "Como posso contribuir para NOFX?",
    "faqHowToContributeAnswer": "Crie PRs, traduza documentação, sugira estratégias. Você pode receber Airdrops/Recompensas.",
    "faqPRGuidelines": "Quais os guias de PR (Pull Request)?",
    "faqPRGuidelinesAnswer": "Faça branches pequenas a partir da 'dev', certifique-se que o lint passou no frontend e os testes em Go no backend.",
    "faqBountyProgram": "Existe programa de recompensas (Bounty)?",
    "faqBountyProgramAnswer": "Sim! Você acumula pontos resolvendo problemas e sugerindo patches que se traduzem em incentivos do ecossistema.",
    "faqReportBugs": "Como reportar falhas?",
    "faqReportBugsAnswer": "Abra uma issue no GitHub detalhando os logs e passos.",
    "environmentCheck": {
      "button": "Verificar Ambiente Seguro",
      "checking": "Verificando...",
      "description": "Verificando se o navegador suporta Web Crypto antes de inserir chaves.",
      "secureTitle": "Contexto seguro detectado",
      "secureDesc": "A API Web Crypto está disponível. Você pode continuar preenchendo as chaves com criptografia habilitada.",
      "insecureTitle": "Contexto inseguro",
      "insecureDesc": "A página não está sob HTTPS ou localhost, portanto o navegador bloqueará criptografia local.",
      ...
      "unsupportedDesc": "Abra sob HTTPS/localhost para que o navegador exponha a engine Web Crypto.",
      "summary": "Origem: {origin} • Protocolo: {protocol}",
      "disabledTitle": "Transporte criptografado desligado",
      "disabledDesc": "Transporte por HTTPS desativado. Chaves circularão limpas na rede interna. Ative TRANSPORT_ENCRYPTION=true."
    },
    "environmentSteps": {
