...
export const coinSource = {
  ...
  staticDesc: {
    ...
    pt: 'Especificar moedas manualmente',
  },
  mixedConfig: {
    zh: '组合数据源配置',
    en: 'Combined Sources Configuration',
    es: 'Configuración Combinada',
    pt: 'Configuração de Fontes Combinadas',
  },
  mixedSummary: {
    zh: '已选组合',
    en: 'Selected Sources',
    es: 'Fuentes Seleccionadas',
    pt: 'Fontes Selecionadas',
  },
  ...
  dataSourceConfig: {
    ...
    pt: 'Configuração de Fonte de Dados',
  },
  excludedCoins: {
    zh: '排除币种',
    en: 'Excluded Coins',
  ...
  excludedCoinsDesc: {
    ...
    es: 'Estas monedas serán excluidas',
    pt: 'Estas moedas serão excluídas de todas as fontes e não serão negociadas',
  },
  addExcludedCoin: {
    zh: '添加排除',
    en: 'Add Excluded',
    es: 'Agregar Excluida',
    pt: 'Adicionar Exclusão',
  },
  nofxosNote: {
    zh: '使用 NofxOS API Key（在指标配置中设置）',
    en: 'Uses NofxOS API Key (set in Indicators config)',
    es: 'Usa API Key de NofxOS',
    pt: 'Usa API Key do NofxOS (definida em Indicadores)',
  },
}
...
export const gridConfig = {
  tradingPair: {
    ...
    pt: 'Configuração de Negociação',
  },
  gridParameters: {
    zh: '网格参数',
    en: 'Grid Parameters',
    es: 'Parámetros de Grid',
    pt: 'Parâmetros da Grade',
  },
  priceBounds: {
    zh: '价格边界',
    en: 'Price Bounds',
    es: 'Límites de Precio',
    pt: 'Limites de Preço',
  },
  riskControl: {
    zh: '风险控制',
    ...
    pt: 'Controle de Risco',
  },
  symbol: {
    zh: '交易对',
    en: 'Trading Pair',
    es: 'Par de Trading',
    pt: 'Par de Negociação',
  },
  symbolDesc: {
    zh: '选择要进行网格交易的交易对',
    en: 'Select trading pair for grid trading',
    es: 'Seleccionar par',
    pt: 'Selecione o par para trading em grade',
  },
  totalInvestment: {
    zh: '投资金额 (USDT)',
    en: 'Investment (USDT)',
    es: 'Inversión (USDT)',
    pt: 'Investimento (USDT)',
  },
  totalInvestmentDesc: {
    zh: '网格策略的总投资金额',
    en: 'Total investment for grid strategy',
    es: 'Inversión total',
    pt: 'Investimento total para a estratégia de grade',
  },
  leverage: {
    zh: '杠杆倍数',
    en: 'Leverage',
  ...
  leverageDesc: {
    ...
    pt: 'Alavancagem para trading (1-5)',
  },
  gridCount: {
    zh: '网格数量',
    en: 'Grid Count',
    es: 'Cantidad de Grids',
    pt: 'Número de Grades',
  },
  gridCountDesc: {
    zh: '网格层级数量 (5-50)',
    ...
    es: 'Niveles (5-50)',
    pt: 'Número de níveis da grade (5-50)',
  },
  distribution: {
    zh: '资金分配方式',
    en: 'Distribution',
  ...
  distributionDesc: {
    ...
    pt: 'Alocação de fundos entre os níveis da grade',
  },
  ...
  useAtrBounds: {
    ...
    pt: 'Cálculo Automático de Limites (ATR)',
  },
  useAtrBoundsDesc: {
    zh: '基于 ATR 自动计算网格上下边界',
    en: 'Auto-calculate bounds based on ATR',
    es: 'Calcular automáticamente',
    pt: 'Calcular limites automaticamente com base no ATR',
  },
  atrMultiplier: {
    zh: 'ATR 倍数',
    en: 'ATR Multiplier',
  ...
  atrMultiplierDesc: {
    ...
    es: 'Distancia en ATR',
    pt: 'Multiplicador ATR para distância dos limites',
  },
  upperPrice: {
    zh: '上边界价格',
    en: 'Upper Price',
    es: 'Precio Superior',
    pt: 'Preço Limite Superior',
  },
  upperPriceDesc: {
    zh: '网格上边界价格 (0=自动计算)',
    en: 'Grid upper bound (0=auto)',
    es: 'Límite superior (0=auto)',
    pt: 'Limite superior da grade (0=auto)',
  },
  lowerPrice: {
    zh: '下边界价格',
    en: 'Lower Price',
    es: 'Precio Inferior',
    pt: 'Preço Limite Inferior',
  },
  lowerPriceDesc: {
    zh: '网格下边界价格 (0=自动计算)',
    en: 'Grid lower bound (0=auto)',
    es: 'Límite inferior (0=auto)',
    pt: 'Limite inferior da grade (0=auto)',
  },
  maxDrawdown: {
    zh: '最大回撤 (%)',
    en: 'Max Drawdown (%)',
  ...
  maxDrawdownDesc: {
    ...
    es: 'Drawdown máximo',
    pt: 'Drawdown máximo antes da saída de emergência',
  },
  stopLoss: {
    zh: '止损 (%)',
    en: 'Stop Loss (%)',
  ...
  directionBiasRatioDesc: {
    ...
    es: 'Fuerza del sesgo',
    pt: 'Força para os modos viés de alta/baixa',
  },
  directionBiasExplain: {
    ...
    pt: 'Viés Alta: X% compra + (100-X)% venda | Viés Baixa: (100-X)% compra + X% venda',
  },
  directionExplain: {
    ...
    es: 'Break corto → sesgo',
    pt: 'Rompimento Curto → viés, Rompimento Médio → cheio, Retorno de Preço → retorno gradual ao neutro',
  },
  directionModes: {
    zh: '方向模式说明',
    en: 'Direction Modes',
  ...
  modeNeutral: {
    ...
    es: 'Neutral: 50/50',
    pt: 'Neutro: 50% compra + 50% venda (padrão)',
  },
  modeLongBias: {
    zh: '偏多：X%买 + (100-X)%卖',
    en: 'Long Bias: X% buy + (100-X)% sell',
    es: 'Sesgo Largo',
    pt: 'Viés de Alta: X% compra + (100-X)% venda',
  },
  modeLong: {
    zh: '全多：100%买 + 0%卖',
    en: 'Long: 100% buy + 0% sell',
    es: 'Largo: 100%',
    pt: 'Alta (Long): 100% compra + 0% venda',
  },
  modeShortBias: {
    zh: '偏空：(100-X)%买 + X%卖',
    en: 'Short Bias: (100-X)% buy + X% sell',
    es: 'Sesgo Corto',
    pt: 'Viés de Baixa: (100-X)% compra + X% venda',
  },
  modeShort: {
    zh: '全空：0%买 + 100%卖',
    en: 'Short: 0% buy + 100% sell',
    es: 'Corto: 100%',
    pt: 'Baixa (Short): 0% compra + 100% venda',
  },
}
...
export const riskControl = {
  ...
  btcEthPositionValueRatioDesc: {
    ...
    pt: 'Valor máx. da posição = patrimônio × este ratio (FORÇADO POR CÓDIGO)',
  },
  altcoinPositionValueRatio: {
    zh: '山寨币仓位价值比例',
    en: 'Altcoin Position Value Ratio',
    es: 'Altcoin Ratio',
    pt: 'Ratio de Valor de Posição Altcoin',
  },
  ...
  minRiskReward: {
    ...
    es: 'Ratio Riesgo/Recompensa',
    pt: 'Ratio Risco/Retorno Mínimo',
  },
  minRiskRewardDesc: {
    zh: '开仓要求的最低盈亏比',
    en: 'Minimum profit ratio for entry',
    es: 'Ratio mínimo',
    pt: 'Ratio de lucro mínimo para entrada',
  },
  maxMarginUsage: {
    zh: '最大保证金使用率（代码强制）',
    en: 'Max Margin Usage (CODE ENFORCED)',
    es: 'Uso Máximo de Margen',
    pt: 'Uso Máximo de Margem (FORÇADO POR CÓDIGO)',
  },
  maxMarginUsageDesc: {
    zh: '保证金使用率上限，由代码强制执行',
    en: 'Maximum margin utilization, enforced by code',
    es: 'Límite de margen',
    pt: 'Limite de utilização de margem, forçado via código',
  },
  entryRequirements: {
    zh: '开仓要求',
  ...
  minPositionSize: {
    ...
    es: 'Tamaño Mínimo',
    pt: 'Tamanho Mínimo da Posição',
  },
  minPositionSizeDesc: {
    zh: 'USDT 最小名义价值',
    en: 'Minimum notional value in USDT',
    es: 'Valor mínimo USDT',
    pt: 'Valor nocional mínimo em USDT',
  },
  minConfidence: {
    zh: '最小信心度',
    en: 'Min Confidence',
  ...
  minConfidenceDesc: {
    ...
    es: 'Umbral AI',
    pt: 'Limite de confiança da IA para entrada',
  },
}
...
export const promptSections = {
  promptSections: {
    ...
    pt: 'Customização do System Prompt',
  },
  promptSectionsDesc: {
    zh: '自定义 AI 行为和决策逻辑（输出格式和风控规则不可修改）',
    en: 'Customize AI behavior and decision logic (output format and risk rules are fixed)',
    es: 'Personalizar IA',
    pt: 'Personalize o comportamento e lógica de decisão da IA (formato de saída e regras de risco são fixos)',
  },
  roleDefinition: {
    zh: '角色定义',
    en: 'Role Definition',
    es: 'Definición de Rol',
    pt: 'Definição de Papel',
  },
  roleDefinitionDesc: {
    zh: '定义 AI 的身份和核心目标',
    en: 'Define AI identity and core objectives',
    es: 'Identidad AI',
    pt: 'Define a identidade e os objetivos centrais da IA',
  },
  tradingFrequency: {
    zh: '交易频率',
    en: 'Trading Frequency',
    es: 'Frecuencia',
    pt: 'Frequência de Trading',
  },
  tradingFrequencyDesc: {
    zh: '设定交易频率预期和过度交易警告',
    en: 'Set trading frequency expectations and overtrading warnings',
    es: 'Frecuencia',
    pt: 'Define expectativas de frequência e avisos de overtrading',
  },
  entryStandards: {
    zh: '开仓标准',
    en: 'Entry Standards',
    es: 'Estándares',
    pt: 'Padrões de Entrada',
  },
  entryStandardsDesc: {
    zh: '定义开仓信号条件和避免事项',
    en: 'Define entry signal conditions and avoidances',
    es: 'Señales',
    pt: 'Define condições de sinal de entrada e o que evitar',
  },
  decisionProcess: {
    zh: '决策流程',
    en: 'Decision Process',
    es: 'Proceso',
    pt: 'Processo de Decisão',
  },
  decisionProcessDesc: {
    zh: '设定决策步骤和思考流程',
    en: 'Set decision steps and thinking process',
    es: 'Pasos',
    pt: 'Define as etapas de decisão e fluxo de pensamento',
  },
  resetToDefault: {
    zh: '重置为默认',
    en: 'Reset to Default',
...
export const indicator = {
  ...
  marketDataDesc: {
    ...
    es: 'Datos precio',
    pt: 'Dados de preço essenciais para análise da IA',
  },
  technicalIndicators: {
    zh: '技术指标',
  ...
  technicalIndicatorsDesc: {
    ...
    pt: 'Indicadores opcionais; a IA pode calculá-los por conta própria',
  },
  marketSentiment: {
    zh: '市场情绪',
    en: 'Market Sentiment',
    es: 'Sentimiento',
    pt: 'Sentimento de Mercado',
  },
  marketSentimentDesc: {
    zh: '持仓量、资金费率等市场情绪数据',
    en: 'OI, funding rate and market sentiment data',
    es: 'Sentimiento',
    pt: 'Dados de OI, taxa de financiamento e sentimento',
  },
  quantData: {
    zh: '量化数据',
    en: 'Quant Data',
    es: 'Datos Quant',
    pt: 'Dados Quantitativos',
  },
  quantDataDesc: {
    zh: '资金流向、大户动向',
    en: 'Netflow, whale movements',
    es: 'Netflow, ballenas',
    pt: 'Fluxo líquido, movimentação de baleias',
  },
  timeframes: {
    zh: '时间周期',
    en: 'Timeframes',
  ...
  timeframesDesc: {
    ...
    es: 'Timeframes',
    pt: 'Selecione os períodos das velas, ★ = principal (clique duplo)',
  },
  klineCount: {
    zh: 'K 线数量',
    en: 'K-line Count',
    es: 'Velas',
    pt: 'Quantidade de Velas',
  },
  ...
  position: {
    ...
    en: 'Position',
    es: 'Posición',
    pt: 'Posição (Tendência)',
  },
  rawKlines: {
    zh: 'OHLCV 原始 K 线',
    en: 'Raw OHLCV K-lines',
    es: 'Velas OHLCV',
    pt: 'Velas OHLCV Brutas',
  },
  rawKlinesDesc: {
    zh: '必须 - 开高低收量原始数据，AI 核心分析依据',
    en: 'Required - Open/High/Low/Close/Volume data for AI',
    es: 'Datos esenciales',
    pt: 'Obrigatório - Dados de Abertura/Máxima/Mínima/Fechamento/Volume',
  },
  ...
  macdDesc: {
    ...
    es: 'MACD',
    pt: 'Convergência/Divergência de Médias Móveis',
  },
  ...
  bollDesc: {
    ...
    es: 'Bandas',
    pt: 'Bandas Superior/Média/Inferior',
  },
  ...
  volumeDesc: {
    ...
    es: 'Volumen',
    pt: 'Análise de volume de negociação',
  },
  oi: {
    zh: '持仓量',
    en: 'Open Interest',
  ...
  oiDesc: {
    ...
    es: 'OI',
    pt: 'Contratos em aberto em futuros',
  },
  fundingRate: {
    zh: '资金费率',
    en: 'Funding Rate',
  ...
  fundingRateDesc: {
    ...
    es: 'Funding',
    pt: 'Taxa de financiamento de contratos perpétuos',
  },
  oiRanking: {
    zh: 'OI 排行',
    en: 'OI Ranking',
  ...
  oiRankingDesc: {
    ...
    es: 'Cambios OI',
    pt: 'Ranking de variação do Open Interest',
  },
  oiRankingNote: {
    zh: '显示持仓量增加/减少的币种排行，帮助发现资金流向',
    en: 'Shows coins with OI increase/decrease, helps identify capital flow',
    es: 'Flujo capital',
    pt: 'Mostra moedas com aumento/redução de OI, ajudando a identificar fluxo de capital',
  },
  ...
  netflowRankingDesc: {
    ...
    es: 'Institucional',
    pt: 'Fluxo de fundos institucional/varejo',
  },
  netflowRankingNote: {
    zh: '显示机构资金流入/流出排行，散户动向对比，发现聪明钱信号',
    en: 'Shows institution inflow/outflow ranking, retail flow comparison, Smart Money signals',
    es: 'Smart Money',
    pt: 'Mostra ranking de entrada/saída institucional e sinais de Smart Money',
  },
  priceRanking: {
    zh: '涨跌幅排行',
    en: 'Price Ranking',
    es: 'Ranking Precios',
    pt: 'Ranking de Preços',
  },
  priceRankingDesc: {
    zh: '涨跌幅排行榜',
    en: 'Gainers/losers ranking',
    es: 'Ganadores',
    pt: 'Ranking de maiores altas/baixas',
  },
  priceRankingNote: {
    zh: '显示涨幅/跌幅排行，结合资金流和持仓变化分析趋势强度',
    en: 'Shows top gainers/losers, combined with fund flow and OI for trend analysis',
    es: 'Fuerza tendencia',
    pt: 'Mostra maiores altas/baixas, combinado com NetFlow e OI para analisar força da tendência',
  },
  priceRankingMulti: {
    zh: '多周期',
    en: 'Multi-period',
  ...
  aiCanCalculate: {
    ...
    es: '💡 Tip: AI puede calcularlos',
    pt: '💡 Dica: A IA pode calcular estes indicadores; habilitá-los reduz a carga de processamento da IA',
  },
  nofxosTitle: {
    zh: 'NofxOS 量化数据源',
    en: 'NofxOS Data Provider',
    es: 'Proveedor NofxOS',
    pt: 'Provedor de Dados NofxOS',
  },
  nofxosDesc: {
    zh: '专业加密货币量化数据服务',
    en: 'Professional crypto quant data service',
    es: 'Servicio quant',
    pt: 'Serviço profissional de dados quantitativos de cripto',
  },
  nofxosFeatures: {
    zh: 'AI500 · OI排行 · 资金流向 · 涨跌榜',
    en: 'AI500 · OI Ranking · Fund Flow · Price Ranking',
    es: 'Ranking',
    pt: 'AI500 · Ranking de OI · NetFlow · Ranking de Preços',
  },
  viewApiDocs: {
    zh: 'API 文档',
    en: 'API Docs',
...
export const publishSettings = {
  publishToMarket: {
    ...
    pt: 'Publicar no Mercado',
  },
  publishDesc: {
    zh: '策略将在市场公开展示，其他用户可发现并使用',
    en: 'Strategy will be publicly visible in the marketplace',
    es: 'Visible públicamente',
    pt: 'A estratégia ficará visível publicamente no marketplace',
  },
  showConfig: {
    zh: '公开配置参数',
    en: 'Show Config',
    es: 'Mostrar Config',
    pt: 'Mostrar Configuração',
  },
  showConfigDesc: {
    zh: '允许他人查看和复制详细配置',
    en: 'Allow others to view and clone config details',
    es: 'Permitir clonación',
    pt: 'Permitir que outros visualizem e clonem os detalhes da configuração',
  },
...
export const ptStrategy = {
  ...
  ...Object.fromEntries(
    Object.entries(promptSections).map(([k, v]) => [k, v.pt])
  ),
  ...Object.fromEntries(Object.entries(indicator).map(([k, v]) => [k, v.pt])),
  ...Object.fromEntries(
    Object.entries(publishSettings).map(([k, v]) => [k, v.pt])
  ),
